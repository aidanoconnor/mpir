...
mp_limb_t refmpn_addadd_n __GMP_PROTO ((mp_ptr rp, mp_srcptr xp, mp_srcptr yp,mp_srcptr zp, mp_size_t n));

mp_limb_t refmpn_subadd_n __GMP_PROTO ((mp_ptr rp, mp_srcptr xp, mp_srcptr yp,mp_srcptr zp, mp_size_t n));

int refmpn_addsub_n __GMP_PROTO ((mp_ptr rp, mp_srcptr xp, mp_srcptr yp, mp_srcptr zp, mp_size_t n));
...
mp_limb_t refmpn_rsh_divrem_hensel_qr_1 __GMP_PROTO ((mp_ptr rp, mp_srcptr sp, mp_size_t size,mp_limb_t divisor,int,mp_limb_t));
...
void refmpn_mul_n __GMP_PROTO ((mp_ptr prodp, mp_srcptr up, mp_srcptr vp,
                           mp_size_t size));
void refmpn_mulmid_basecase __GMP_PROTO ((mp_ptr rp, mp_srcptr up, mp_size_t un,
...
mp_limb_t refmpn_rshift_or_copy_any __GMP_PROTO ((mp_ptr wp,
                                                  mp_srcptr xp, mp_size_t size,
                                                  unsigned shift));
mp_limb_t refmpn_rshift1 __GMP_PROTO ((mp_ptr rp, mp_srcptr xp, mp_size_t n));
mp_limb_t refmpn_rshift2 __GMP_PROTO ((mp_ptr rp, mp_srcptr xp, mp_size_t n));
...
void refmpn_store __GMP_PROTO ((mp_ptr p, mp_size_t s,mp_limb_t));
